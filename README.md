...
- `improve_binary/`: C++ search tool, long-running experiment script, collected result file, MILP exponent-normalization post-optimizer, and bit-level XOR post-optimization experiments for binary-field constructions.
